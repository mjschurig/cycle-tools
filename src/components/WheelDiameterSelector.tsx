...
export const COMMON_WHEEL_SIZES: WheelSize[] = [
  ...
  },
  {
    name: '29" Mountain',
    diameter: 622,
    description: 'Large mountain bike wheel (same rim as 700C)'
  },
  {
    name: '20" BMX/Folding',
    diameter: 406,
  ...
  {
    name: '16" Kids/Folding',
    diameter: 349,
    description: 'Kids bike and compact folding bike wheel'
  },
  {
    name: '24" Kids/Cruiser',
    diameter: 507,
    description: 'Kids bike and cruiser wheel'
  },
  {
    name: '650C (Triathlon)',
    diameter: 571,
    description: 'Smaller road wheel for triathlon/TT bikes'
  },
  {
    name: '27" Vintage',
    diameter: 630,
    description: 'Vintage road bike wheel'
  },
  {
    name: 'Custom',
    diameter: 622,
    description: 'Enter custom diameter'
  }
];
